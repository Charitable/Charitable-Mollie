...
module.exports = function(grunt) {
        ...
        makepot: {
            target: {
                options: {
                    ...
                    exclude: ['build/.*'],
                    mainFile: 'charitable-mollie.php',    // Main project file.
                    potFilename: 'charitable-mollie.pot',    // Name of the POT file.
                    potHeaders: {
    ...
    grunt.registerTask( 'classmap', 'Generate class to file array" task.', function() {
        ...
        grunt.file.write('includes/autoloader/charitable-mollie-class-map.php', map );
    } );
