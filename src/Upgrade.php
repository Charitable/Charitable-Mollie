...
if ( ! class_exists( '\Charitable\Pro\Mollie\Upgrade' ) ) :
	...
	class Upgrade extends \Charitable_Upgrade {
		 ...
		 * @since 1.0.0
		 *
		 * @var   \Charitable\Pro\Mollie\Upgrade
		 */
		 ...
		 * @var   string
		 */
		protected $upgrade_log_key = 'charitable_mollie_upgrade_log';
		 ...
		 * @var   string
		 */
		protected $version_key = 'charitable_mollie_version';
		 ...
		 * @since  1.0.0
		 *
		 * @return \Charitable\Pro\Mollie\Upgrade
		 */
